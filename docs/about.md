...
我们是一个面向全国青少年的CTF平台，是免费且公益的。我们拥有青少年CTF训练平台、青少年CTF在线工具、青少年CTF论坛和您正在访问的青少年CTF优秀文库。

## 联系我们

=== "QQ"

    [QQ群2群（主要） :fontawesome-brands-qq:](https://qm.qq.com/q/8v0mEMFPcA){ .md-button }
    [QQ群1群（已满） :fontawesome-brands-qq:](https://qm.qq.com/q/2gRbpaRPdm){ .md-button }
...
!!! note "关于靶场的文件传输"
    ...
    靶场文件传输自2026年1月20日起，不再支持原先的SFTP与SMB传输，目前使用新的方式进行文件传输。
